...
22. **KHỐI KÝ CHUẨN — kích thước và khoảng cách (Bạn chốt 09/9/2026, vụ công văn xin ý kiến Bài toán lớn số 2 phải sửa 4 lượt):** (a) giữa đoạn cuối thân văn bản và bảng ký/nơi nhận **đúng 1 paragraph trống** (không 0, không 2); (b) ô ký: chức danh (1–3 dòng) + **tối thiểu 3 paragraph trống 13pt** + tên người ký — đủ chỗ ký, đóng dấu; (c) **tên lãnh đạo ngang dòng "Lưu:"**: số dòng trống = (số dòng cột Nơi nhận kể cả tiêu đề) − (số dòng chức danh) − 1, làm tròn xuống 1 dòng khi Nơi nhận 11pt và ký 13pt; mỗi dòng Nơi nhận phải nằm gọn 1 dòng (≤ 45 ký tự, viết tắt QLNL, QLTM, KH-TH, VP Sở, BQL…), không để wrap làm lệch; (d) **không được co khối ký để ép vừa trang** — thiếu chỗ thì rút thân văn bản, gộp mục, chuyển phòng nội bộ xuống Nơi nhận; (e) Word ngắt trang khác LibreOffice: gán `keep_with_next` cho **2 đoạn cuối + dòng trống** trước bảng ký và `<w:cantSplit/>` cho hàng ký, để khối ký không rơi một mình sang trang mới hoặc tên ký bị đẩy sang trang sau. QA: `qa_all.py` tag **SIGSPACE** (tự kiểm (a), (b), (c)); ảnh render soi bằng mắt điều (c). *(Chi tiết: Nhóm H13.)*
