...
| Báo cáo chuyên đề gửi Bộ Công Thương (khó khăn, kiến nghị) | `examples/sct/bao-cao-ccn-gui-bct-ban-chuan-nguoi-dung.docx` | `/BC-SCT` | KT. GĐ - PGĐ Nguyễn Đình Chiến | **Bản chuẩn người dùng đã sửa tay 24/7/2026** — mẫu vàng cho Kính gửi 1 nơi (1 dòng căn giữa, không bảng, không chấm cuối), Nơi nhận có Cục chuyên môn + "- Ban Giám đốc Sở;", bảng ký không trHeight. Cấu trúc: mở đầu → I. Khó khăn, vướng mắc (tiêu đề con mang thông điệp) → II. Đề xuất, kiến nghị → kết |
| Công văn xin ý kiến các cơ quan (phối hợp liên ngành, có deadline) | `examples/sct/cong-van-xin-y-kien-cac-co-quan-phuong-an-ccn-von-nsnn.docx` | `/SCT-CN`, V/v tham gia ý kiến | KT. GĐ - PGĐ Nguyễn Đình Chiến | **Mẫu vàng 24/7/2026** cho công văn xin ý kiến nhiều cơ quan: Kính gửi khối thụt lề (left 1701/hanging 708; các dòng nơi nhận left 2268, nhóm theo loại "- Các Sở: ...;", "- UBND các xã: ...;"); mở đầu "Thực hiện Văn bản số ... của UBND tỉnh ... trong đó giao ..."; thân dạng gạch đầu dòng: phạm vi ý kiến (nêu rõ yêu cầu chọn 1 trong 2 phương án) + deadline đậm "trước ngày ..."; ghi chú nghiêng "(Gửi kèm: 1. ...; 2. ...; 3. ...)"; kết "đề nghị các cơ quan, đơn vị quan tâm, phối hợp thực hiện./."; Nơi nhận có "- Giám đốc Sở (báo cáo);" |
| Công văn xin ý kiến sở, ngành về dự thảo VBQPPL do bộ gửi lấy ý kiến | `examples/sct/cong-van-xin-y-kien-du-thao-vbqppl-bo-nganh.docx` | `/SCT-CN`, V/v tham gia ý kiến | KT. GĐ - PGĐ Hoàng Văn Thuân | **Mẫu vàng 28/7/2026** — bản gọn 01 TRANG cho việc UBND tỉnh giao Sở chủ trì lấy ý kiến 2-3 cơ quan về dự thảo nghị định/thông tư của bộ (vụ thật: dự thảo NĐ sửa đổi NĐ 181/2024 về VLNCN, TCTN — CV 5633/BCT-ATMT ngày 22/7/2026, giao tại VB 7653/UBND-KT ngày 27/7/2026). Khác mẫu liên ngành: chỉ 03 đoạn thân — mở đầu gộp căn cứ + lời đề nghị ("..., Sở Công Thương đề nghị Quý cơ quan như sau:"), 01 gạch đầu dòng yêu cầu TỔNG QUÁT (nghiên cứu, tham gia ý kiến theo yêu cầu của bộ và các nội dung thuộc phạm vi QLNN của cơ quan mình — KHÔNG liệt kê điều, khoản kẻo bó hẹp phạm vi góp ý), 01 gạch deadline đậm cụm ngày kèm mục đích "để tổng hợp, gửi Bộ ... và báo cáo UBND tỉnh"; Kính gửi dạng bảng 2 cột; Nơi nhận rút gọn "- Như trên; - Lưu: VT, CN(tên)." |
| Công văn đôn đốc chủ đầu tư hạ tầng CCN + chế độ báo cáo hằng tuần | `examples/sct/cong-van-don-doc-tien-do-ha-tang-ccn-bao-cao-hang-tuan.docx` | `/SCT-CN`, V/v đôn đốc tiến độ | KT. GĐ - PGĐ Nguyễn Đình Chiến | **Mẫu vàng 24/7/2026** cho công văn đôn đốc nhiều doanh nghiệp: Kính gửi dạng bảng 2 cột (1985/7479), mỗi dòng "- Tên DN (tên CCN);"; thân 3 mục đề mục đậm: 1. Khẩn trương triển khai đúng tiến độ, 2. Chế độ báo cáo hằng tuần, 3. Xử lý trường hợp chậm (chế tài Điều 12 NĐ 32/2024: điều chỉnh QĐ, thay chủ đầu tư, bãi bỏ QĐ thành lập); câu kết cho phép "phản ánh về Sở (qua Phòng QLCN) để được hướng dẫn" — xem lưu ý Nhóm I |
...
| Công văn nội bộ Phòng (tham gia ý kiến hồ sơ) | `examples/sct/cong-van-noi-bo-phong-tham-gia-y-kien-kcn.docx` | (nội bộ, KHÔNG cấp số) | Trưởng phòng QLCN | **Mẫu thật cho Chế độ B của loại "công văn nội bộ phòng" (template 08)**. Phòng QLCN gửi Phòng KH-TH tham gia ý kiến hồ sơ đề xuất đầu tư hạ tầng KCN (Phú Xuân); Kính gửi 1 phòng; mở đầu "Phòng QLCN nhận được Văn bản số .../BQL-QHXD..."; thân 1. Sự phù hợp quy hoạch, 2. Nội dung đề nghị làm rõ/bổ sung, 3. Kết luận; kết "đề nghị Phòng KH-TH nghiên cứu, tổng hợp"; Lưu: CN. Đối chiếu nội dung KCN với `kcn-ccn-vn` | **Từ 21/8/2026 mẫu này chỉ dùng tra khung header/footer; phong cách thân văn bản theo 2 mẫu vàng dưới đây (bỏ a) b) c), bỏ đề mục Kết luận).** |
| Công văn nội bộ Phòng - tham gia ý kiến (dự án hạ tầng cắt qua CCN) | `examples/sct/cong-van-noi-bo-phong-tham-gia-y-kien-tuyen-110kv-qua-ccn.docx` | (nội bộ, KHÔNG cấp số) | TRƯỞNG PHÒNG Nguyễn Hữu Long | **Mẫu vàng 21/8/2026 — phong cách chuẩn công văn nội bộ phòng tham gia ý kiến** (vụ thật: đoạn tuyến ĐZ 110kV Âu Lâu cắt qua khu đất quy hoạch CCN Bảo Hưng 2, trả lời CV 288/SCT-NL của Phòng QLNL). Thân: đề mục đậm `1.` (hiện trạng/bối cảnh) và `2.` (ý kiến) — KHÔNG có đề mục `3. Kết luận`, kết luận là đoạn thường cuối; trong mục 2 các ý là gạch đầu dòng nhãn nghiêng `- Về ...:` (không dùng a) b) c)); tên CCN viết thường "cụm công nghiệp Bảo Hưng 2". Chứa trọn **bộ 4 lớp bảo vệ pháp lý** khi Phòng chấp thuận phương án từng phản đối: (i) ghi nhận thành văn quan điểm nhất quán của Phòng tại các cuộc họp (đề nghị đi mép ranh giới CCN); (ii) quy nguồn lý do thay đổi cho ý kiến của các đơn vị tại cuộc họp (tăng chi phí, kéo dài tiến độ); (iii) quy trách nhiệm tính chính xác số liệu so sánh cho chủ đầu tư, tư vấn; (iv) chốt "phương án tối ưu **tại thời điểm hiện nay**" + điều kiện cung cấp tọa độ VN-2000 KTT 104°45'. |
| Công văn nội bộ Phòng - tham gia ý kiến (hồ sơ đa lĩnh vực, khoanh vùng chức năng) | `examples/sct/cong-van-noi-bo-phong-tham-gia-y-kien-thu-hoi-cat-long-ho.docx` | (nội bộ, KHÔNG cấp số) | TRƯỞNG PHÒNG Nguyễn Hữu Long | **Mẫu vàng 21/8/2026 — biến thể "khoanh vùng phạm vi"** (vụ thật: hồ sơ đăng ký thu hồi cát VLXDTT khi nạo vét lòng hồ thủy điện Nậm Lúc, CV 7972/SNNMT-KS, Phòng QLNL chủ trì). Dùng khi hồ sơ xin ý kiến trải nhiều lĩnh vực mà Phòng chỉ phụ trách một phần: mục `1. Về phạm vi tham gia ý kiến` nêu rõ việc nào thuộc cơ quan/phòng nào và câu chốt "không tham gia ý kiến đối với các nội dung thuộc trách nhiệm của cơ quan, đơn vị khác"; mục `2.` chỉ nêu ý kiến đúng chức năng (nguyên tắc + đề nghị đưa ràng buộc vào văn bản của cơ quan chủ trì), kèm câu quy trách nhiệm hồ sơ, số liệu cho đơn vị đăng ký/chủ đầu tư; kết "Trên đây là ý kiến tham gia...; đề nghị ... xem xét, tổng hợp./.". Nội dung khoáng sản đối chiếu `qlks-sct-vn` ref 17. |
...
## Cảnh báo thể thức header của mẫu thật (rà soát 05/7/2026)

Kết quả quét toàn bộ `examples/` bằng đếm shape (`<w:pict`) — dùng khi chọn mẫu Chế độ B:

- **2 mẫu dùng paragraph border (`w:pBdr`) thay Line shape** cho đường kẻ header — TRÁI quy ước ("không dùng paragraph border"): `examples/sct/bao-cao-tinh-hinh-trien-khai-ccn.docx` và `examples/ubnd/bao-cao-vp-ubnd.docx`. Hai file là văn bản thật đã ban hành nên GIỮ NGUYÊN làm tư liệu, nhưng khi dùng làm mẫu dựng văn bản MỚI phải **thay pBdr bằng đối tượng Line** (mã VML tại `reference/the-thuc-code.md` mục 2 và `cong-cu-ky-thuat.md` mục 5), hoặc chọn mẫu khác cùng loại có Line chuẩn (vd `bao-cao-ket-qua-thang-atvsld.docx` — 3 Line).
- Số Line chuẩn theo loại: công văn/tờ trình/báo cáo/kế hoạch/QĐ có header 2 cột → **2 Line** (dưới tên cơ quan + dưới Tiêu ngữ); biên bản/GCN ATTP Quốc hiệu căn giữa → **1 Line** (dưới Tiêu ngữ); một số mẫu có thêm Line trang trí khác (3-4) là bình thường.
- QA sau khi dựng từ mẫu: `python3 scripts/qa_pdf_check.py <file> [--min-lines 1|2]`.
