...
- **QĐ 1883/QĐ-UBND ngày 06/11/2025** — UBND tỉnh **ủy quyền Giám đốc Sở Công Thương** thực hiện nhiệm vụ **huấn luyện, kiểm tra, cấp, cấp lại Giấy chứng nhận huấn luyện KTAT VLNCN** (TTHC 2.000229, 2.000210), thời hạn đến hết **28/02/2027** — nội dung chi tiết tại `hl-vlncn-sct-vn/references/01-phap-ly.md` mục C. ⚠ Đây **KHÔNG** phải quyết định ủy quyền cấp Giấy phép sử dụng VLNCN. Việc cấp GP sử dụng VLNCN được ủy quyền riêng tại **QĐ 2867/QĐ-UBND ngày 17/8/2026** (hiệu lực 20/8/2026 → 28/02/2027): Sở cấp, ký hiệu `/GP-SCT`, KT. GĐ – PGĐ Hoàng Văn Thuân ký; giấy phép đến 19/8/2026 vẫn là `/GP-UBND` do Chủ tịch UBND tỉnh ký (xem mục IV và `sd-vlncn-sct-vn` ref 10). Đã có **bản ký thật** tại `hl-vlncn-sct-vn/van-ban-goc/2025.11.06-1883.QD.UBND-...ban-ky.pdf` — viện dẫn thẳng, không cần xác minh lại.
