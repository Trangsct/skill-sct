...
- **NĐ 347/2026/NĐ-CP ngày 08/9/2026** (hiệu lực **15/9/2026**; 📗 `van-ban-goc/ND-347-2026-ND-CP-08-9-2026-sua-doi-ND-105-2025.docx`) — sửa NĐ 105/2025 về PCCC: **bãi bỏ khoản 5 Điều 6** (CQCM về xây dựng kiểm tra nghiệm thu PCCC cùng KTCTNT) và **Điều 10** (Công an kiểm tra nghiệm thu, Mẫu PC15-PC17); chủ đầu tư **tự nghiệm thu PCCC**, chịu trách nhiệm, khai báo CSDL PCCC trước khi đưa vào hoạt động (điểm đ k1 Đ12); thẩm định PCCC của CQCM chỉ trong BCNCKT (k1 Đ6); **Điều 39 bãi bỏ Điều 74 NĐ 217/2026** (nội dung đã đưa vào k1 Đ6 NĐ 105). Công an tỉnh triển khai tại CV 6501/CAT-PCCC ngày 23/9/2026. Chi tiết: `pccc-sct-vn` ref 16.
...
- **KTCTNT (Đ17 khoản 1):** CQCM về xây dựng cấp tỉnh kiểm tra công trình chuyên ngành trên địa bàn tỉnh (trừ công trình do cấp xã quyết định đầu tư chỉ lập BCKTKT); đồng thời tổ chức **kiểm tra PCCC hằng năm** theo điểm b khoản 2 Điều 13 NĐ 105/2025 (trình tự: khoản 3 Điều 14 NĐ 105 sửa bởi NĐ 347/2026 — kế hoạch trước 15/12, báo trước 03 ngày làm việc, biên bản PC03).
...
15. **PCCC trong KTCTNT từ 15/9/2026 (NĐ 347/2026):** KTCTNT **không kèm kiểm tra nghiệm thu PCCC** (k5 Đ6 NĐ 105 đã bãi bỏ); không yêu cầu văn bản chấp thuận kết quả nghiệm thu PCCC của Công an trong hồ sơ; chỉ đối chiếu văn bản thẩm định thiết kế PCCC và biên bản nghiệm thu PCCC do chủ đầu tư tổ chức; thông báo KTCTNT nhắc CĐT khai báo CSDL PCCC và báo Công an tỉnh thời gian đưa vào hoạt động (CV 6501/CAT-PCCC). Không dẫn Điều 74 NĐ 217/2026 (đã bãi bỏ) — dẫn khoản 1 Điều 6 NĐ 105 sửa bởi NĐ 347.
