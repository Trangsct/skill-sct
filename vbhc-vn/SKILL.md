---
name: vbhc-vn
description: "Soạn thảo, rà soát văn bản hành chính (.docx) của Sở Công Thương tỉnh Lào Cai: công văn, tờ trình, báo cáo, kế hoạch, quyết định, giấy phép (kể cả vận chuyển HHNH), giấy chứng nhận ATTP, công văn nội bộ phòng; và văn bản cấp UBND tỉnh/VP do Sở dự thảo (giấy mời, công văn chỉ đạo, thông báo kết luận, phiếu trình). Dùng cho tham mưu, thẩm định, góp ý dự thảo, bài phát biểu, VBQPPL; VÀ khi nhận PDF văn bản đến chạy scripts/extract_metadata.py đọc đúng số/ngày/người ký. Hợp nhất: soạn thảo (Chế độ A template, Chế độ B sửa file gốc); 7 nhóm anti-error; đọc PDF metadata; VĂN BẢN GỐC 3 Phụ lục NĐ 30/2020 (thể thức, kỹ thuật trình bày, cỡ chữ, lề, sơ đồ ô, quy tắc viết hoa, bảng chữ viết tắt tên loại văn bản) — dùng khi hỏi về thể thức hoặc trình bày theo Nghị định 30/2020/NĐ-CP. Trigger: soạn/tạo/rà soát/sửa/tham mưu/thẩm định/góp ý/triển khai; ký hiệu SCT-CN, TTr-SCT, BC-SCT, KH-SCT, QĐ-SCT, GP-SCT, GCNATTP-SCTLC; tên file PDF chứa CV/QĐ/TTr/BC/KH/NQ/NĐ/TT/UBND/BYT/BCT/SCT/HĐND."
---
...
- `reference/phong-tranh-sai-lam.md` — chi tiết 7 nhóm sai lầm + checklist + vụ thật.
...
**Luôn áp dụng mục "Phòng tránh 7 nhóm sai lầm tham mưu"** (đã hợp nhất từ `anti-error-sct-vn`) ở cuối skill này: tránh bịa số văn bản, suy diễn nhiệm vụ, dùng từ suy đoán trong bản trình ký, dùng VBPL hết hiệu lực, tin context window với PDF. Xem mục "Đọc PDF văn bản đến" (đã hợp nhất từ vbhc-pdf-reader-vn — xác minh số/ngày từ PDF công văn đến). Đối chiếu nội dung chuyên môn với `kcn-ccn-vn`/`hnh-sct-vn`.
...
## Phòng tránh 7 nhóm sai lầm tham mưu (luôn áp dụng)
