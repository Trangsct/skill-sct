## [2.23.2] - 17/9/2026 — normalize_body.py: ba vùng bảo vệ (đoạn trống kề bảng, đoạn chứa shape/ngắt trang, khối Kính gửi)

- **Nguồn:** chạy lại chính script mới trên hai văn bản đã giao (công văn hướng dẫn 08 CCN có phụ lục mẫu Thông báo, Thông báo CCN Đông An) thì script đòi xóa nhầm: 2 đoạn trống kẹp khối Nơi nhận - chữ ký và bảng phụ lục; đoạn rỗng chứa **đường kẻ dưới trích yếu** (v:line) của mẫu Thông báo; và đòi ép lùi đầu dòng khối **Kính gửi** (left=1134, firstLine=0) về 1cm.
- **scripts/normalize_body.py**: (1) giữ mọi đoạn trống có anh chị em liền kề là `w:tbl`; (2) định nghĩa lại "đoạn rỗng" = không chữ VÀ không chứa `w:pict`, `w:drawing`, `w:br`, `w:object`, `mc:AlternateContent`; (3) hàm `khoi_kinh_gui()` bỏ qua đoạn "Kính gửi", các dòng tiếp theo còn lề trái riêng và dòng trống ngay dưới khối. Chạy lại: hai văn bản đã chuẩn → 0/0/0/0; file gốc của UBND xã vẫn bắt 3 numPr, 36 ind lệch, 24 tab, 6 đoạn trống thừa.
...
- **kccn-sct-vn 1.36.0** — `references/38-ccn-khanh-yen-thuong-du-an-giay-da-van-bao.md` (mới): nền CCN Khánh Yên Thượng; nhà đầu tư ông HUANG, YU - CHIEH và tổ chức kinh tế **Công ty TNHH Công nghiệp Văn Bảo** (MST 5300854562, trụ sở trong cụm); chuỗi pháp lý 5 mốc kèm 02 báo cáo thẩm định của Sở Tài chính (844/BC-STC, 915/BC-STC); 02 nội dung điều chỉnh; Điều 2 trách nhiệm nhà đầu tư và chế độ báo cáo Điều 94 NĐ 96/2026; **mẫu quy trình 07 bước bổ sung tổ chức kinh tế** khi nhà đầu tư cá nhân lập doanh nghiệp (39 ngày xử lý); cảnh báo cấm suy đoán quy mô và cấm nâng tỷ lệ lấp đầy của cụm khi chưa có QĐ 2428. SKILL.md thêm nghiệp vụ 15. **Phân vai:** dự án thứ cấp ngoài KCN do Sở Tài chính thẩm định, Chủ tịch UBND tỉnh quyết định (khác ref 33 — trong KCN do BQLCKCN).
- **dacn-sct-vn 1.6.0** — `du-lieu/danh-muc-du-an.json` thêm bản ghi **CBCT-081** (trạng thái CT, chỉ tính vào chỉ tiêu vốn đầu tư), mở rộng `_pham_vi` sang dự án thứ cấp trong CCN; trường `quy_mo` để trống có chủ đích vì chưa có QĐ 2428. Tổng 96 bản ghi.
- **Việc còn treo:** xin bản gốc **QĐ 2428/QĐ-UBND ngày 14/7/2026** (workflow *Tim van ban vien dan* ở kho `vlncn-laocai`, hoặc đề nghị Sở Tài chính) để điền diện tích, tổng vốn, công suất, tiến độ, lao động và biết nội dung khoản trách nhiệm đã bị bãi bỏ.
...
- **`references/01` mục 5 MỚI — quy trình chuẩn lập một quy hoạch ngành quốc gia:** bảng 3 giai đoạn (lập-thẩm định-phê duyệt **NHIỆM VỤ** → lập-thẩm định-phê duyệt **QUY HOẠCH** kèm ĐMC và tư vấn phản biện độc lập → **CÔNG BỐ**, bàn giao hồ sơ lưu giữ), Hội đồng thẩm định do **Thủ tướng hoặc Phó Thủ tướng làm Chủ tịch** (Điều 30 Luật Quy hoạch). Cột riêng đánh dấu **2 lần địa phương được lấy ý kiến**: lần 1 góp *nhiệm vụ* (phạm vi, đối tượng, phương pháp — góp danh mục mỏ lúc này là lạc đề), **lần 2 mới là lúc đề nghị đưa mỏ/dự án của tỉnh vào danh mục**; bỏ lỡ lần 2 thì sau đó phải xin **điều chỉnh quy hoạch**, thủ tục nặng hơn nhiều (xem QĐ 2581 ở ref 07). Kèm 2 lưu ý: văn bản của tỉnh về quy hoạch ngành là **kiến nghị gửi Bộ chủ trì**, không phải "đề nghị phê duyệt"; từ 15/9/2026 đầu mối quy hoạch khoáng sản (cả nhóm I và VLXD) là **Bộ Công Thương**.
- **`references/10` mục V viết lại thành "hai văn bản lịch sử về quy hoạch KS làm VLXD"** — V.1 QĐ 154 (nội dung cũ, đánh số lại) và **V.2 QĐ 836 MỚI**: 3 giai đoạn + tiến độ dự kiến, phân công các Vụ thuộc Bộ XD, và **bảng dự kiến vs thực tế** — QĐ 836 dự kiến Thủ tướng phê duyệt quy hoạch **10/2021**, thực tế QĐ 1626 ban hành **15/12/2023**, chậm **≈26 tháng**. Đó chính là lý do phải có QĐ 154/QĐ-TTg 29/01/2022. Mạch liền **QĐ 836 → QĐ 154 → QĐ 1626** trả lời câu hỏi kinh điển của thanh tra, kiểm toán: *"vì sao giai đoạn 2021-2023 vẫn cấp phép theo quy hoạch đã hết kỳ 2020?"*. Anti-error **8 → 9 lỗi** (thêm: không dẫn QĐ 836 như một quy hoạch).
- `references/04` thêm dòng QĐ 995 + QĐ 836; `SKILL.md`, `README.md`, `sources/00-MUC-LUC-NGUON.md`, `van-ban-goc/00-MUC-LUC.md` cập nhật; bản gốc DOCX + toàn văn text đã lưu.
- `scripts/check_facts.py`: rule mới `qd836-khong-phai-quy-hoach` (FAIL) — chặn việc dẫn QĐ 836 như quy hoạch hoặc như nguồn danh mục mỏ/trữ lượng. `registry/trang-thai.csv` thêm QĐ 836 và QĐ 995 (ghi rõ QĐ 995 **chưa có bản gốc**, số/ngày đọc từ phần căn cứ của QĐ 836); `build_registry.py` chạy lại — 617 văn bản. `marketplace.json` metadata 4.11.67.

## 13/9/2026 — quy-hoach-ct-vn 1.3.0 + qlks-sct-vn 2.1.0: chuỗi chủ trương → chiến lược khoáng sản quốc gia (NQ 10-NQ/TW, NQ 88/NQ-CP, QĐ 334/QĐ-TTg, QĐ 154/QĐ-TTg) và toàn văn QĐ 2581/QĐ-TTg (mỏ đồng Tả Phời)

- **quy-hoach-ct-vn 1.3.0**: `references/10` MỚI — sơ đồ chuỗi 4 cấp (chủ trương → chương trình hành động → chiến lược → quy hoạch); **NQ 10-NQ/TW 10/02/2022** (5 quan điểm, mục tiêu 2025/2030/2045, câu về luyện cán thép mỏ sắt Quý Xa, triển khai CTr 39-CTr/TU + KH 200/KH-UBND); **NQ 88/NQ-CP 22/7/2022** (danh mục 18 nhiệm vụ — nhiệm vụ 7 "đặt hàng" QĐ 866 do **Bộ Công Thương** chủ trì lập, số 8 → QĐ 1626, số 11 → QH tỉnh có phương án bảo vệ - sử dụng KS, số 16 → dự trữ KS quốc gia theo QĐ 645/2014 + NĐ 51/2021); **QĐ 334/QĐ-TTg 01/4/2023** (Chiến lược: 3 trụ mục tiêu tổng quát, bảng mục tiêu cụ thể, **bảng định hướng thăm dò - khai thác - chế biến 8 loại khoáng sản liên quan Lào Cai**, 10 loại dự trữ KS quốc gia, bảng phân công Điều 2); **QĐ 154/QĐ-TTg 29/01/2022** (kéo dài kỳ QH KS làm VLXD + xi măng — lịch sử, hết vai trò từ 15/12/2023); 8 anti-error.
- **quy-hoach-ct-vn 1.3.0** — `references/07` mục A viết lại từ **toàn văn QĐ 2581 đã ký**: **chốt dấu thập phân cột công suất** (QĐ in "967.434"/"8.473" → phải đọc **967,434 và 8,473 ×10³ tấn/năm**, chứng minh bằng tuổi mỏ ≈16 năm và đối chiếu phụ lục dự thảo) — điểm trước đây ref 07 còn để ngỏ; **bảng tọa độ khép góc đầy đủ 4 khu** (A 25,0 ha · khu chính 161,3 ha gồm 113 ha đã CPKT · C 37,0 ha · D 25,0 ha = 248,3 ha, phần đã cấp phép 200 ha) hệ VN2000 KTT 105 múi 6°; cảnh báo **QĐ 2581 là quyết định cho 03 tỉnh** (Phụ lục I Núi Pháo - Thái Nguyên, Phụ lục II Tả Phời - Lào Cai, Phụ lục III bôxit - Đồng Nai); cảnh báo **vênh tên xã trong chính bản gốc** (danh mục dự án ghi "xã Hợp Thành", bảng tọa độ giữ "Tả Phời, xã Tả Phời"). `van-ban-goc/` MỚI (05 DOCX + mục lục) + 05 file toàn văn trong `sources/`.
- **qlks-sct-vn 2.1.0**: `references/24` MỚI, viết theo hướng **"Sở phải làm gì"** (không lặp toàn văn): bảng 6 loại văn bản nói rõ **khi nào dẫn / khi nào KHÔNG dẫn** chiến lược, khối thứ tự căn cứ chuẩn; **hai nghĩa vụ thường xuyên dễ bỏ sót** — hằng năm **bố trí kinh phí bảo vệ khoáng sản chưa khai thác** (NQ 88 II.2, QĐ 334 IV.3 + Điều 2 k9) và **báo cáo kết quả trước 31/12 hằng năm**, kèm cảnh báo **đầu mối đã đổi 2 lần** (Bộ TN&MT → Bộ NN&MT → **Bộ Công Thương từ 15/9/2026**); 6 mốc hạn 2025/2030 gắn phần việc SCT; bảng định hướng QĐ 334 nêu đích danh Lào Cai cho 7 nhóm (trong đó **"chất thải công nghiệp thay thế cát, sỏi lòng sông"** là lập luận chiến lược cho hồ sơ đất đá thải mỏ); **3 loại dự trữ KS quốc gia có trên địa bàn** (apatit, đá hoa trắng, đất hiếm) → bắt buộc kiểm tra chồng lấn; 6 nguyên tắc QĐ 334 dùng ngay trong công văn; 8 anti-error. `references/01` thêm mục 0, `references/09` thêm 3 dòng.
- Lưu ý pháp lý đã ghi vào reference: QĐ 334 căn cứ **Luật Khoáng sản 2010** (đã bị Luật ĐC&KS 54/2024 thay) — vẫn viện dẫn được ở lớp định hướng nhưng khi dẫn điều khoản cụ thể phải dẫn Luật 54/2024 + Luật 147/2025; đã ghi cảnh báo kiểm tra hiệu lực.
- Nguồn: 05 văn bản DOCX công khai cấp trung ương Bạn cung cấp 13/9/2026; bản gốc lưu tại `quy-hoach-ct-vn/skills/quy-hoach-ct-vn/van-ban-goc/`, không nhân bản sang plugin khác.
...
- **qlks-sct-vn 1.9.1 → 2.0.0 (major):** ref 23 mới — toàn văn 7 điều NQ 66.25 (Điều 3 k2: nhiệm vụ của Sở NN&MT, Sở XD tại Điều 8 NĐ 150/2025 và Điều 25 NĐ 193/2025 do **Sở Công Thương** thực hiện; Điều 4 chuyển tiếp; Điều 7 bàn giao nguyên trạng cả biên chế, dự toán; Phụ lục 74 VBQPPL), ma trận trước/sau 15/9/2026, checklist 7 việc Sở làm ngay, nguyên tắc hành văn; bản gốc PDF; SKILL.md 13 nghiệp vụ, GATE mốc 15/9/2026; ref 01, 02 (đánh dấu lịch sử), 11.
- **dacn-sct-vn 1.4.0 → 1.5.0:** ref 11 mới — QĐ 21/2026/QĐ-TTg (10 nhóm công nghệ, toàn văn 30 sản phẩm chiến lược, ánh xạ SP 17/18/20/23/25 với Lào Cai), QĐ 1493/QĐ-TTg, Bài toán lớn số 2 (7 sản phẩm TB 78; dự thảo Kế hoạch UBND tỉnh 05/9/2026: 05 chuỗi giá trị, 16 nhiệm vụ, 42.000 triệu NSNN, chỉ tiêu 2030, nguyên tắc phân công theo NQ 66.25).
- **kccn-sct-vn 1.22.3 → 1.23.0:** ref 29 — Điều 2 NQ 66.25 (KCN: Bộ Tài chính → Bộ Công Thương; Đ7, 13, 40, 53, 57, 68 NĐ 35/2022; Ban Quản lý báo cáo thêm Bộ Công Thương), tỉnh phân công lại, 02 Ban Quản lý không đổi, GATE hành văn.
- **sct-laocai-org-vn 2.2.0 → 2.3.0:** mục mới "Tiếp nhận chức năng QLNN địa chất, khoáng sản, KCN từ 15/9/2026" — bảng trước/sau, ai phụ trách (PGĐ Thuân, PGĐ Chiến, Phòng QLCN), yêu cầu biên chế - dự toán chuyển theo.
- **tkm-sct-vn 1.3.2 → 1.4.0:** GATE 15/9/2026 tại ref 03 mục 2 + SKILL IV (thẩm định thiết kế mỏ nhóm II/III chờ QĐ phân công của tỉnh; hồ sơ chuyển nguyên trạng).
- **xp-sct-vn 1.4.2 → 1.5.0:** ref 06 mục A GATE — 21 điều xử phạt khoáng sản NĐ 36/2020 + k3 Đ6 NĐ 189/2025 chuyển ngành Công Thương; GĐ Sở CT xử phạt; cảnh báo Điều 41 không trong danh sách chuyển; CHANGELOG-v2026.09.05.md.
- **quy-hoach-ct-vn 1.1.2 → 1.2.0:** ref 04 — quy hoạch khoáng sản (NĐ 70/2026 PL I) về Bộ Công Thương; kiến nghị điều chỉnh QĐ 866/2581/1626 gửi Bộ Công Thương.
- **bvmt-sct-vn 1.4.1 → 1.4.2:** dòng đóng cửa mỏ trong bảng phân vai (về SCT từ 15/9/2026; ĐTM/GPMT/ký quỹ vẫn SNNMT).
- **Hạ tầng repo:** `scripts/check_facts.py` thêm 2 rule (`qd-1131-thay-the-qd-21-2026` FAIL; `snnmt-cap-phep-sau-nq-66-25` WARN); `registry/trang-thai.csv` thêm NQ 66.25, NĐ 150/2025, NĐ 35/2022, QĐ 1131 (bị thay), QĐ 21/2026, QĐ 1493; build_registry chạy lại (567 văn bản); rút plugin.json description ≤500 ký tự cho 8 plugin (kể cả hnh-sct-vn 1.11.0 đang lỗi 571 ký tự trên main); sync_marketplace --bump → metadata.version 4.11.33.
- **Chờ dữ kiện:** Quyết định của UBND tỉnh về phân công, chuyển giao theo Điều 7 k5 NQ; Nghị định chức năng các bộ; TT 37/2025/TT-BCT sửa đổi; Kế hoạch Bài toán lớn số 2 khi được ban hành (số/ngày).
