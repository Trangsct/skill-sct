...
**10. THU HỒI KHOÁNG SẢN — hoàn thiện trọn bộ hồ sơ** — references `16` (trục chung), `17` (nạo vét lòng hồ thuỷ điện thu hồi cát sỏi), `18` (đất đá thải mỏ, quặng đuôi, KS đi kèm); mẫu `07`, `08`; checklist `checklist-ho-so-thu-hoi-khoang-san.md`; 10 văn bản thật tại `vi-du-thuc-te/`.
