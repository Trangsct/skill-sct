---
name: vbhc-vn
description: "Soạn thảo, rà soát văn bản hành chính (.docx) của Sở Công Thương tỉnh Lào Cai: công văn, tờ trình, báo cáo, kế hoạch, quyết định, giấy phép (kể cả vận chuyển HHNH), giấy chứng nhận ATTP, công văn nội bộ phòng; và văn bản cấp UBND tỉnh/VP do Sở dự thảo (giấy mời họp, công văn chỉ đạo, thông báo kết luận, phiếu trình, báo cáo VP). Dùng cả cho tham mưu, thẩm định hồ sơ, góp ý dự thảo, viết bài phát biểu, tham gia ý kiến VBQPPL; VÀ khi nhận PDF văn bản nhà nước (công văn đến) chạy scripts/extract_metadata.py đọc đúng số/ngày/người ký. Skill hợp nhất 3 năng lực: soạn thảo (Chế độ A tạo từ template, Chế độ B sửa file gốc giữ định dạng); 7 nhóm anti-error (bịa số VB; suy diễn nhiệm vụ; từ suy đoán; VBPL hết hiệu lực; tin context PDF 2 cột; rebuild thay vì sửa file gốc; thể thức); đọc PDF trích metadata. Trigger: soạn/tạo/rà soát/chỉnh sửa/tham mưu/thẩm định/góp ý/triển khai; ký hiệu SCT-CN, TTr-SCT, BC-SCT, KH-SCT, QĐ-SCT, GP-SCT, GCNATTP-SCTLC; tên file PDF chứa CV/QĐ/TTr/BC/KH/NQ/NĐ/TT/UBND/BYT/BCT/SCT/HĐND."
---
