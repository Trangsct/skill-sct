---
name: dacn-sct-vn
description: "DANH MỤC DỰ ÁN CÔNG NGHIỆP phục vụ MỤC TIÊU TĂNG TRƯỞNG tỉnh Lào Cai theo NQ 169/NQ-CP 27/6/2026. Kích hoạt: tăng trưởng, IIP, GRDP, GTSXCN, dự án động lực, điểm nghẽn, điện thương phẩm, XNK, bán lẻ, Thống kê tỉnh, công nghệ chiến lược, Bài toán lớn số 2. 11 nghiệp vụ: (1) 09 chỉ tiêu SCT chủ trì + phối hợp 2026, 2026-2030; (2) danh mục dự án động lực; (3) phân tích SXCN hằng tháng, cảnh báo SP hụt; (4) điểm nghẽn (GPMB, quy hoạch, đất đai, GPXD, môi trường, PCCC); (5) báo cáo định kỳ trước ngày 20 gửi Sở Tài chính; (6) kịch bản; (7) số liệu KCN, KKT cửa khẩu; (8) giải trình chênh lệch với Thống kê tỉnh; (9) KTXH 6 tháng 2026 (BC 615/BC-TKT: GRDP 9,01%, IIP 9,12%); (10) dự án SXCN dự kiến hoàn thành 2026 (05 nhóm a-đ); (11) QĐ 21/2026/QĐ-TTg (thay QĐ 1131; 30 SP, SP 25 khoáng sản, đất hiếm), QĐ 1493/QĐ-TTg, dự thảo KH Bài toán lớn số 2 (05 chuỗi, 16 nhiệm vụ, 42 tỷ). Sổ dự án thêm dự án thứ cấp trong CCN (giày da, CCN Khánh Yên Thượng, QĐ 3319/2026). Từ khóa: Tằng Loỏng, Quý Xa, thủy điện."
---
...
2. **Lập/cập nhật danh mục dự án động lực tăng trưởng**, xếp nhóm ưu tiên, gắn dự án với chỉ tiêu, ước tính đóng góp → reference `03` + `du-lieu/schema-du-an.json` + script `theo_doi_du_an.py`. Mỗi khi nhận được **quyết định chấp thuận chủ trương đầu tư hoặc quyết định điều chỉnh CTĐT** của một dự án công nghiệp (kể cả dự án thứ cấp trong KCN, CCN): chạy GATE đọc PDF ký số → thêm hoặc cập nhật bản ghi trong `du-lieu/danh-muc-du-an.json`, để trống các trường quy mô chưa có bản gốc thay vì suy đoán.
...
| `du-lieu/danh-muc-du-an.json` | Sổ dữ liệu, **96 bản ghi**. (a) **95 dự án thứ cấp trong 03 KCN do Ban Quản lý các Khu công nghiệp tỉnh quản lý** (phía Nam 66, Minh Quân 17, Âu Lâu 12; tổng vốn đăng ký 15.501,318 tỷ đồng; kỳ số liệu đến 16/4/2026, phụ lục 12/5/2026). (b) **CBCT-081 — Nhà máy sản xuất giày da xuất khẩu, CCN Khánh Yên Thượng, xã Văn Bàn** (bản ghi dự án thứ cấp trong CCN đầu tiên, bổ sung 16/9/2026 theo QĐ 3319/QĐ-UBND ngày 15/9/2026; trạng thái CT; **quy mô còn trống vì chưa có QĐ 2428/QĐ-UBND ngày 14/7/2026**). Chạy `theo_doi_du_an.py kiem-tra` để đọc 05 cảnh báo về dữ liệu gốc trước khi dùng |
...
| Dự án thứ cấp **trong CCN** | UBND cấp xã (cụm vốn NSNN) hoặc CĐT hạ tầng; CTĐT do **Chủ tịch UBND tỉnh** quyết định, **Sở Tài chính** thẩm định | Ghi nhận lẻ khi có QĐ chủ trương đầu tư — hiện 01 bản ghi (CBCT-081, CCN Khánh Yên Thượng). Hồ sơ đầy đủ: `kccn-sct-vn` ref 38 | `danh-muc-du-an.json` |
...
⚠️ **Ba nguồn có cấu trúc khác nhau, KHÔNG cộng dồn cơ học.** Reference `10` chỉ có **mốc và đóng góp dự kiến**, không có hồ sơ dự án đầy đủ như `danh-muc-du-an.json`. **CHƯA có:** dự án thứ cấp trong CCN (trừ 01 bản ghi CBCT-081 đã nạp 16/9/2026), dự án ngoài khu/cụm, hồ sơ đầy đủ của dự án khoáng sản và thuỷ điện, hạ tầng KCN/CCN vùng Lào Cai cũ. Khi lập báo cáo toàn ngành phải bổ sung các nhóm này.
