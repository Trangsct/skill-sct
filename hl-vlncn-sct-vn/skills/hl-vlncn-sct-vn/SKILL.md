...
- **Báo cáo** UBND tỉnh định kỳ hằng năm/đột xuất về thực hiện nhiệm vụ ủy quyền (điểm đ khoản 2 Điều 3 QĐ 1883/QĐ-UBND) → reference `06` + mẫu 13. Lưu ý: từ **20/8/2026** có thêm **QĐ 2867/QĐ-UBND ngày 17/8/2026** ủy quyền GĐ SCT **GP sử dụng VLNCN** (KHÔNG bao gồm GCN huấn luyện — huấn luyện vẫn viện dẫn QĐ 1883; hai QĐ song song đến 28/02/2027) → reference `01` mục C-bis. **CV 5085/SCT-VP ngày 19/8/2026** (GĐ Hoàng Chí Hiền ký) triển khai nội bộ cả hai QĐ: PGĐ Hoàng Văn Thuân trực tiếp chỉ đạo, Phòng QLCN chủ trì tham mưu; không đổi tiền lệ người ký → reference `01` mục C-ter.
...
6. **QĐ số 1883/QĐ-UBND ngày 06/11/2025** của UBND tỉnh Lào Cai — **ỦY QUYỀN GIÁM ĐỐC SỞ CÔNG THƯƠNG** thực hiện huấn luyện, kiểm tra, cấp, cấp lại GCN huấn luyện KTAT VLNCN (TTHC **2.000229** cấp, **2.000210** cấp lại); hiệu lực **đến hết ngày 28/02/2027**; GĐ không được ủy quyền tiếp; dùng hình thức văn bản, con dấu của Sở; báo cáo UBND tỉnh hằng năm/đột xuất. (Trình tại TTr 2205/TTr-SCT ngày 28/10/2025; PCT Nguyễn Thành Sinh ký TM. UBND, KT. CHỦ TỊCH.) ✅ **Bản ký thật + Phụ lục** trong `van-ban-goc/` — viện dẫn thẳng số/ngày, không cần xác minh lại.
6a. **QĐ số 2272/QĐ-UBND ngày 29/6/2026** (hiệu lực 01/7/2026) — **Sở Công Thương là cơ quan tiếp nhận hồ sơ** cấp, cấp lại, cấp điều chỉnh **GCN đủ điều kiện sản xuất tiền chất thuốc nổ**. Liên quan mảng TCTN của skill này (Đ10–14 NĐ 181/2024): người quản lý kho, nơi cất giữ TCTN tại cơ sở sản xuất là đối tượng huấn luyện thuộc thẩm quyền Sở; hồ sơ GCN sản xuất TCTN có đầu mục nhân sự đã huấn luyện. Bản ký: `sd-vlncn-sct-vn/van-ban-goc/2026.06.29-2272.QD.UBND-...pdf`.
...
- **Dòng Lưu**: từ **10/7/2026** chuyên viên VLNCN là **Trần Đăng Khôi** → mặc định **CN(Khôi)** (Thông báo phân công nội bộ Phòng QLCN 10/7/2026, xem skill `sct-laocai-org-vn`). Văn bản thực tế trước 6/7/2026 dùng **CN(Linh)** (Vũ Việt Linh — đúng lịch sử, không sửa); KH/TB/CV và văn bản đoàn kiểm tra có tiền lệ dùng **CN(M.Cường)** (PTP Đỗ Mạnh Cường). Mặc định theo người trực tiếp tham mưu hồ sơ; không rõ thì **hỏi Bạn** — tuyệt đối không điền tên lãnh đạo phòng.
