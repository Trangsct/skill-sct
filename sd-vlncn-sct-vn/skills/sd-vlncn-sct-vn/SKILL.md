...
11. **Văn bản địa phương Lào Cai:** QĐ 05/2025/QĐ-UBND ngày 01/7/2025 (chức năng SCT); ✅ **QĐ 1883/QĐ-UBND ngày 06/11/2025** (bản ký thật trong `hl-vlncn-sct-vn/van-ban-goc/`) — ủy quyền GĐ SCT **huấn luyện, kiểm tra, cấp/cấp lại GCN huấn luyện KTAT VLNCN** (TTHC 2.000229, 2.000210), đến hết 28/02/2027, viện dẫn thẳng không cần xác minh; ⭐ **QĐ 2272/QĐ-UBND ngày 29/6/2026** (hiệu lực 01/7/2026, bản ký trong `van-ban-goc/`) — **SCT là cơ quan tiếp nhận hồ sơ GCN đủ điều kiện sản xuất tiền chất thuốc nổ** (chi tiết: reference `10` dòng A2, A9 và reference `01` mục 9); ⭐ **QĐ 2867/QĐ-UBND ngày 17/8/2026** (hiệu lực **20/8/2026 → hết 28/02/2027**, bản ký trong `van-ban-goc/`) — **ủy quyền GĐ SCT thực hiện một số nhiệm vụ, quyền hạn của UBND tỉnh trong lĩnh vực VLNCN** theo Phụ lục kèm theo. ⚠ **Bản lưu chưa có Phụ lục danh mục → chưa rõ phạm vi ủy quyền cụ thể (có bao GP sử dụng VLNCN hay không); trước khi viện dẫn hoặc xác định ai ký GP từ 20/8/2026 phải đối chiếu Phụ lục** — chi tiết reference `10` mục A-bis, reference `01` mục 9.

## III. THẨM QUYỀN — PHÂN ĐỊNH NHANH (từ 01/7/2025)

| Việc | Cơ quan | Ghi chú |
|---|---|---|
| Cấp/cấp lại/điều chỉnh **GP sử dụng VLNCN** trên địa bàn | **Chủ tịch UBND tỉnh** ký (KT. PCT Nguyễn Thành Sinh), ký hiệu `/GP-UBND`, SCT thẩm định + Tờ trình | Trừ 2 ngoại lệ dưới. ⚠ Từ **20/8/2026** kiểm tra Phụ lục **QĐ 2867/QĐ-UBND** (ủy quyền GĐ SCT lĩnh vực VLNCN — phạm vi chưa xác minh, ref `10` A-bis) trước khi xác định người ký |
