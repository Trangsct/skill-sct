---
name: hc-sct-vn
description: "HÓA CHẤT - QLNN của Sở Công Thương Lào Cai theo khung 2026 (Luật Hóa chất 69/2025, NĐ 24/25/26/2026, TT 01+02/2026). Kích hoạt: GCN đủ điều kiện sản xuất, kinh doanh hóa chất có điều kiện; hóa chất cần kiểm soát đặc biệt nhóm 1-2; dịch vụ tồn trữ; Kế hoạch phòng ngừa, ứng phó sự cố hóa chất; khai báo hóa chất nhập khẩu; huấn luyện an toàn hóa chất. 6 nghiệp vụ: (1) thẩm định, tham mưu cấp/cấp lại/điều chỉnh/thu hồi GCN đủ điều kiện; GCN dịch vụ tồn trữ; Giấy phép hóa chất cần kiểm soát đặc biệt nhóm 2 (thẩm quyền UBND cấp tỉnh); (2) thẩm định, phê duyệt Kế hoạch phòng ngừa, ứng phó sự cố hóa chất (kể cả Sở là thành viên Hội đồng của Cục Hóa chất, Phiếu Mẫu 03c, trạm xuất NH3, DAP số 2); (3) hướng dẫn doanh nghiệp hồ sơ, điều kiện; (4) kiểm tra chuyên ngành (NĐ 217/2025); (5) báo cáo cấp trên; (6) soạn công văn, tờ trình, quyết định, báo cáo. Kèm văn bản gốc, biểu mẫu, ví dụ thực tế của Sở. Từ khóa thêm: QCVN 05A, axit HNO3, NH3, tiền chất, CN(Loan), PGĐ Thuân."
---
...
- **Thẩm định, phê duyệt Kế hoạch phòng ngừa, ứng phó sự cố hóa chất** trong lĩnh vực dân sự đối với đối tượng thuộc **điểm b khoản 2 Điều 33 NĐ 25/2026** (UBND cấp tỉnh chủ trì); lập Hội đồng thẩm định; kiểm tra thực tế; ra Quyết định phê duyệt. **Tham gia Hội đồng thẩm định của Cục Hóa chất** với đối tượng điểm a (cơ sở lớn như DAP số 2, NH3 vượt ngưỡng): lập Phiếu nhận xét, đánh giá Mẫu 03c — ref 17.
...
- `17-thanh-vien-hoi-dong-tham-dinh-kh-cuc-hoa-chat.md` — **Sở là thành viên Hội đồng thẩm định KH của Cục Hóa chất** (đối tượng điểm a): phân biệt vai trò, Phiếu Mẫu 03c (cách điền, không tự đánh X, script dựng `vi-du-thuc-te/ke-hoach-su-co/build_phieu_03c.py`), checklist 8 điểm thẩm định nội dung KH (KH điều chỉnh phải khớp 4 chỗ: Bảng 1.2 → 2.1 → 2.2 → mục 4.3 + diễn tập; ngưỡng AEGL 60 phút), điều kiện an toàn trạm xuất NH3/axit, quan hệ KH với thủ tục đầu tư - xây dựng - PCCC - môi trường - GCN/GP kinh doanh (H2SO4 nhóm 2), vụ DAP số 2 08/9/2026.
...
| **2. Thẩm định KH sự cố** | Hồ sơ KH phòng ngừa (đối tượng điểm b); Sở là thành viên Hội đồng của Cục (điểm a) | 06, 12; **17** | QĐ thành lập Hội đồng, QĐ phê duyệt (ref 14); Phiếu Mẫu 03c (ref 17) |
...
2. **Hình thức nộp:** nộp trực tuyến trên Cổng dịch vụ công một cửa Bộ Công Thương https://motcua-tthc.moit.gov.vn/ — nơi nộp DUY NHẤT (đăng nhập VNeID; Bạn chốt lại 02/9/2026); phòng thụ lý: **Phòng Quản lý Công nghiệp**.
