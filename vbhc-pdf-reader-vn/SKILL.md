...
- **anti-error-sct-vn**: Nhóm E — Tin context window đối với PDF có header 2 cột. Skill anti-error là tuyến phòng vệ thứ hai khi skill này không được tự kích hoạt.
